...
const Index = () => {
  ...
  const handleAuthClick = (type: "login" | "signup" | "logout") => {
    if (type === "logout") {
      signOut();
    } else {
      setAuthModal({
      ...
      <footer className="bg-secondary/20 py-12 border-t border-primary/20">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-muted-foreground mb-6 max-w-2xl mx-auto">
            The ultimate decentralized gaming multiverse where creators build,
            players compete, and everyone earns.
          </p>
          ...
          <div className="flex justify-center space-x-6 mb-6">
            ...
            <a
              href="https://www.reddit.com/r/NexuzArena/"
              className="text-2xl hover:text-primary transition-colors"
            ...
            <a
              href="https://discord.gg/3Wv3YqMHJR"
              className="text-2xl hover:text-primary transition-colors"
          ...
          <p className="text-xs text-muted-foreground">
            © 2025 Nexuz Arena. Built on the blockchain, powered by the
            community.
          </p>
        </div>
      </footer>
