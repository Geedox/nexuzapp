...
const AdminWithdrawals = () => {
  ...
  const handleApprove = (requestId: string) => {
    ...
    toast({
      ...
      description:
        "The withdrawal request has been approved and will be processed shortly.",
    });
  };
    ...
    <>
      <div className="space-y-6">
        <div className="flex flex-col md:flex-row gap-4 md:gap-0 text-center md:text-start items-center justify-between">
          <div>
            <h1 className="text-3xl font-cyber font-bold text-primary">
              Withdrawal Requests
            </h1>
            <p className="text-muted-foreground">
              Manage manual withdrawal approvals
            </p>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
          <Card className="border-primary/20 bg-card/50">
            <CardContent className="p-6">
              <div className="flex items-center justify-between">
                <div>
                  <div className="text-2xl font-bold font-cyber text-yellow-500">
                    8
                  </div>
          ...
          <Card className="border-primary/20 bg-card/50">
            <CardContent className="p-6">
              <div className="flex items-center justify-between">
                <div>
                  <div className="text-2xl font-bold font-cyber text-green-500">
                    156
                  </div>
          ...
          <Card className="border-primary/20 bg-card/50">
            <CardContent className="p-6">
              <div className="flex items-center justify-between">
                <div>
                  <div className="text-2xl font-bold font-cyber text-red-500">
                    12
                  </div>
          ...
          <Card className="border-primary/20 bg-card/50">
            <CardContent className="p-6">
              <div className="flex items-center justify-between">
                <div>
                  <div className="text-2xl font-bold font-cyber text-blue-500">
                    $45,230
                  </div>
              ...
              <TableBody>
                {filteredRequests.map((request) => (
                  <TableRow key={request.id}>
                    ...
                    <TableCell className="font-mono">
                      {request.userBalance.toFixed(2)} {request.currency}
                    </TableCell>
                ...
                <Card>
                  ...
                  <CardContent className="space-y-2">
                    <div className="flex justify-between">
                      ...
                      <span className="font-bold">
                        {selectedRequest.userBalance} {selectedRequest.currency}
                      </span>
                    </div>
