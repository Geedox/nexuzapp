    ...
    <section className="min-h-screen flex items-center justify-center relative overflow-hidden floating-particles ">
      ...
      <div className="container mx-auto px-4 text-center relative z-10 mb-10">
        <div className="animate-slide-up">
          ...
          <div className="bg-black/40 backdrop-blur-lg border border-primary/30 rounded-2xl p-8 max-w-2xl mx-auto mb-7 md:mb-12 hologram-effect">
            <div className="text-center transition-all duration-100 md:animate-float" key={currentStat}>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:mt-16 max-w-6xl mx-auto">
            <div className="bg-gradient-to-br from-primary/20 to-purple-500/20 p-6 rounded-xl border border-primary/30 hover:border-primary/60 transition-all duration-300 transform hover:scale-105 md:animate-float" style={{ animationDelay: '0s' }}>
