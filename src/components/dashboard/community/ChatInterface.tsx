...
const ChatInterface = ({
  ...
  const { user } = useAuth();
  const { messages, loadingMessages, sendMessage, currentRoom, onlineUsers } =
        ...
        <div className="flex items-center space-x-4">
          ...
          <div className="flex items-center space-x-3">
            {type === "room" && currentRoom && (
              <div
                className={`w-10 h-10 rounded-lg bg-gradient-to-r ${currentRoom.avatar_color} flex items-center justify-center text-lg`}
              >
        ...
        <form onSubmit={handleSendMessage} className="flex items-end space-x-2">
          ...
          <div className="flex-1">
            <Input
              ...
              placeholder={`Message ${
                type === "room" ? roomName : "your friend"
              }...`}
        ...
        <div className="flex justify-between items-center mt-2">
          <div className="text-xs text-muted-foreground">
            {message.length > 950 && (
              <span
                className={
                  message.length > 1000 ? "text-red-400" : "text-yellow-400"
                }
              >
                {message.length}/1000
              </span>
