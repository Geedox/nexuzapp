...
const LeaderboardsPage = () => {
  ...
  }, [activeTab]); // Removed the function dependencies to prevent infinite loops
            ...
            >
              <div className="flex items-center space-x-4">
                ...
                <div>
                  <div className="font-cyber text-lg font-bold text-foreground">
                    {player.user?.display_name || player.user?.username || 'Anonymous'}
                  </div>
                  <div className="flex items-center space-x-3">
                    ...
                    <span className="text-xs text-muted-foreground font-cyber">
                      {isGlobal 
                        ? `${player.wins || 0} wins • ${player.games_played || 0} games`
              ...
              <div className="text-right">
                ...
                <div className="text-xs text-muted-foreground font-cyber">
                  {isGlobal ? `${player.total_score.toLocaleString()} total score` : 'High Score'}
                </div>
              </div>
            </div>
          );
    ...
    <div className="space-y-8 animate-fade-in">
      ...
      <div className="bg-secondary/20 border border-primary/20 rounded-xl p-4">
        ...
        <div className="flex flex-wrap gap-2 text-xs">
          ...
          <span className="bg-gray-500/20 text-gray-400 px-2 py-1 rounded-full font-cyber">ROOKIE</span>
        </div>
      </div>
    </div>
  );
