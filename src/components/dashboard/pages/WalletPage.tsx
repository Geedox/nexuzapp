  ...
  return (
    <div className="space-y-8 animate-fade-in">
        ...
        <div className="flex items-center gap-4 mb-4">
          ...
          <div className="flex-1">
            ...
            <p className="text-muted-foreground">
              Sui Network • Cetus DEX • Multi-token Support
            </p>
          </div>
          <Button
          ...
          >
            <RefreshCw
              className={`w-4 h-4 ${refreshingBalances ? "animate-spin" : ""}`}
            />
          </Button>
        </div>
        ...
        <div className="bg-black/40 rounded-lg p-4 flex items-center justify-between">
          ...
          <div className="flex gap-2">
            ...
            <Button
              onClick={() =>
                window.open(
                  `https://suivision.xyz/account/${profile.sui_wallet_data.address}?network=${NETWORK}`,
                  "_blank"
                )
              }
              variant="outline"
      ...
      <div className="bg-gradient-to-r from-primary/20 to-accent/20 border border-primary/30 rounded-xl p-6 text-center">
        ...
        <div className="text-xs text-blue-400 font-cyber mt-2">
          Powered by Cetus Protocol • Deep Liquidity
        </div>
      </div>
