              ...
              {sidebarItems.map((item) => (
                <SidebarMenuItem key={item.id}>
                  <SidebarMenuButton
                    ...
                    className={`hover:bg-primary/20 hover:text-primary transition-all duration-300 group font-cyber ${activeSection === item.id
              ...
              {supportItems.map((item) => (
                <SidebarMenuItem key={item.id}>
                  <SidebarMenuButton
                    ...
                    className={`hover:bg-primary/20 hover:text-primary transition-all duration-300 group font-cyber ${item.id === 'logout' ? 'hover:bg-red-500/20 hover:text-red-400' : ''
                      }`}
                  >
                    <item.icon className="group-hover:scale-110 transition-transform" />
                    <span className="font-medium">{item.title}</span>
